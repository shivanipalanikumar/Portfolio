module.exports = {
    ...
    author: "@Shivani",
    siteTitle: "portfolio",
    siteShortTitle: "Shivani's Portfolio", // Used as logo text in header, footer, and splash screen
    siteDescription: "A modern one-page portfolio with a clean yet expressive design.",
    siteUrl: "https://gatsby-starter-portfolio-minimal.netlify.app/",
    siteLanguage: "en_US",
    siteIcon: "src/content/female-developer-vector.jpg", // Relative to gatsby-config file
    ...
    socialMedia: [
        {
            name: "Linkedin",
            url: "https://www.linkedin.com/in/shivani-p-83316a1b2/"
        },

        {
            name: "Github",
            url: "https://github.com/shivanipalanikumar"
        },
